...
void ofApp::update(){
    ...
    for (int i = 0; i < particles.size(); i++){
     ...
     ofLog(OF_LOG_NOTICE, ofToString(particles[10].pos.z));
...
//    }
    ...
    float notice = particles[2].pos.x;
    
  //  ofLog(OF_LOG_NOTICE,ofToString(particles[2].pos.x) + ofToString(particles[2].pos.y) + ofToString(particles[2].pos.z));
    ...
    ofSetColor(255,0, 0);
    ofCircle(ofGetMouseX(), ofGetMouseY(),(ofGetMouseX() + ofGetMouseY())/2,10);
